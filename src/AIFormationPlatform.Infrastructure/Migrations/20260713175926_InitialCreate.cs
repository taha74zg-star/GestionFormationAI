        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreation = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "GETUTCDATE()"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inscriptions_UserId_FormationId",
                table: "Inscriptions",
                columns: new[] { "UserId", "FormationId" },
                unique: true);

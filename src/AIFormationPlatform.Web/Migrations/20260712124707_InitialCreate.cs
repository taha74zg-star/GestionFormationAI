        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<int>(type: "integer", nullable: false),
                    AnswerChoiceId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentAnswers_AnswerChoices_AnswerChoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIConversations_LessonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_UserId_FormationId",
                table: "Enrollments",
                columns: new[] { "UserId", "FormationId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Formations_IsPublished",
                table: "Formations",
                column: "IsPublished");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAnswers_AnswerChoiceId",
